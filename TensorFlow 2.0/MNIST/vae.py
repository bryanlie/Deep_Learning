...
random_vec2gen = tf.random.normal(shape=[num_examples2gen, latent_dim])
...
generate_and_save_images(model, 0, random_vec2gen)
...
for epoch in range(1, epochs + 1):
    ...
    if epoch % 1 == 0:
        ...
        generate_and_save_images(model, epoch, random_vec2gen)
